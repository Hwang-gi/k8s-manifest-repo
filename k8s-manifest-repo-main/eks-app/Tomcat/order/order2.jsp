...
183번째 줄: 로고 클릭 시 dog_site.jsp로 이동
190번째 줄: HOTEL 클릭 시 sub05.jsp로 이동
193번째 줄: CONTACT 클릭 시 sub02.jsp로 이동
198번째 줄: 우측 로그인 버튼 클릭 시 sub01.jsp로 이동
-->
                ...
                <div class="container">
                    ...
                    <div class="services">
                        <% // DB 연결 설정 String dbURL="jdbc:mariadb://10.0.0.251:3306/initial_db" ; String dbUser="boss" ;
                            ...
                            (FROM=테이블 name 롤링업데이트시 참고) String
                            sql="SELECT service_name, description, price, image_url FROM services2" ;
                            ...
                            <div class="service-item">
                                ...
                                <p class="price">₩<%= String.format("%,.0f", price) %>
                                </p>
