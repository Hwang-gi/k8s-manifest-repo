            ...
            <head>
                ...
                <style>
                    * {
                    ...
                    /*섹션 01*/
                    #container {
                        background: url(../img/light_blue.png) no-repeat 0 0;
                        margin-top: 6%;
                        margin-bottom: 20%;
                    }
                    ...
                    .title-wrap .title-wrap-top h3 {
                        font-size: 70px;
                        letter-spacing: 0.5px;
                        font-family: "Cormorant Garamond";
                    }

                    .title-wrap .title-wrap-top p {
                        font-size: 19px;
                        font-weight: 600;
                        color: #b1a58c;
                        padding-top: 22px;
                    ...
                    .gallery::before {
                        left: 0;
                        background: linear-gradient(to right, rgb(255 249 237) 0%, rgba(255, 255, 255, 0) 100%);
                    }

                    .gallery::after {
                        right: 0;
                        background: linear-gradient(to left, rgb(255 249 237) 0%, rgba(255, 255, 255, 0) 100%);
                    }
                    ...
                    .footer-bottom .social_icon a img {
                        height: 30px;
                        width: 30px;
                    }
                </style>
                            ...
                            <% String loginid=(String) session.getAttribute("loginid"); %>
                                <% if (loginid !=null) { %>
                                    ...
                                    <% if (loginid.equals("admin")) { %>
                                        <button class="signup-btn" onclick="location.href='reservation_info.jsp'"> 예약자
                                            정보 조회
                                        </button>
                                        <% } %>
                                            <button class="signup-btn" onclick="location.href='logout.jsp'">
                                                로그아웃 </button>
                                            <% } else { %>
                                                <button class="login-btn" onclick="location.href='login.jsp'">
                                                    로그인 </button>
                                                <button class="signup-btn" onclick="location.href='signup.jsp'"> 회원가입
                                                </button>
                                                <% } %>
                        </div>
                ...
                <section class="reviews">
                    ...
                    <div class="review-container">
                        <div class="review-item left">
                            <div class="review-box">
                                <div class="imgContainer">
                                    <img src="../img/review_profile01.jpg" alt="고객 사진" class="review-img">
                                </div>
                        ...
                        <div class="review-item right">
                            <div class="review-box">
                                <div class="imgContainer">
                                    <img src="../img/review_profile02.jpg" alt="고객 사진" class="review-img">
                                </div>
                                <div class="review-content">
                        ...
                        <div class="review-item left">
                            <div class="review-box">
                                <div class="imgContainer">
                                    <img src="../img/review_profile03.jpg" alt="고객 사진" class="review-img">
                                </div>
                                <div class="review-content">
                ...
                <section id="container">
                    ...
                    <div class="youtube_layout">
                        <iframe width="560" height="315"
                            src="https://www.youtube.com/embed/vJEzhJW2n40?si=Lr8rwLKWDwUinb83&amp;controls=0"
